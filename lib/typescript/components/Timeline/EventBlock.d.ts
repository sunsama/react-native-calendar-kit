...
declare const _default: React.MemoExoticComponent<({ event, dayIndex, columnWidth, onPressEvent, onLongPressEvent, timeIntervalHeight, renderEventContent, theme, selectedEventId, eventAnimatedDuration, isPinchActive, }: EventBlockProps) => JSX.Element>;
