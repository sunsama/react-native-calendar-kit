...
const NowIndicator = _ref => {
  ...
  const updateLinePosition = (0, _react.useCallback)(() => {
    recheckTimezoneOffset === null || recheckTimezoneOffset === void 0 ? void 0 : recheckTimezoneOffset();
    const {
      date,
      minutes
  ...
  }, [recheckTimezoneOffset, tzOffset, start, timeIntervalHeight.value, translateY, updateCurrentDate]);
  (0, _react.useEffect)(() => {
    updateLinePosition();
