...
const TimelinePage = _ref => {
  ...
  const _onPressBackgroundHandler = (type, event) => {
    ...
    const dateIsoString = (0, _utils.convertPositionToISOString)(event.nativeEvent.locationX, event.nativeEvent.locationY, startDate, timeIntervalHeight.value, columnWidth, tzOffset);
    switch (type) {
      case 'longPress':
  ...
  const _renderTimelineColumn = dayIndex => {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, {
      ...
      recheckTimezoneOffset: autoRefreshTimezoneOffset ? recheckTimezoneOffset : undefined,
